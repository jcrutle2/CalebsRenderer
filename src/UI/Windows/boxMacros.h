...
#define BOX_SELECTABLE_LIST_SET(box, outVec, getter, setter) UI_SELECTABLE_LIST(box.getTileList(), outVec, getter, setter, "Box", box.getName(), "IndTex", ImVec2(1536,150))
